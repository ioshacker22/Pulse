...
Key features in progress include:

User authentication and profile management

Simulated biometric data integration (heart rate, activity level)

Custom recommendation engine based on scoring logic

Playlist generation and real-time feedback loop (tracking skips, preferences)

Scalable architecture for future AI and third-party API integration

This project focuses on building strong system design fundamentals, including backend architecture, data flow, and algorithmic thinking, while laying the groundwork for advanced features like machine learning and real device integration.
